export default function Page() {
    return <div className="mt-16 md:mt-10">
        ...
        <div className="prose-lg prose max-w-none w-10/12 mx-auto mt-10 text-primary">
            ...
            <h4 className="text-primary">Meus contatos</h4>
            <ul>
                <li >
                    <a href="https://www.linkedin.com/in/lucas-salgado-2a1448254/" target="_blank" className="inline-block w-6 h-6 mx-3 hover:scale-110 transition-all text-primary ease duration-200">
                        Linkedin
                    </a>
                </li>
                <li>
                    <a href="https://github.com/lucasSSalgado" target="_blank" className="inline-block w-6 h-6 mx-3 hover:scale-110 transition-all ease duration-200 text-primary">
                        Github
                    </a>
                </li>
                <li>
                    <a href="https://x.com/lucssslucsss" target="_blank" className="inline-block w-6 h-6 mx-3 hover:scale-110 transition-all ease duration-200 text-primary">
                        Twitter
                    </a>
                </li>
            </ul>
