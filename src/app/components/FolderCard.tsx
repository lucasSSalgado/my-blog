...
export default function FolderCard({ title, description, image }: Props) {
    ...
    return <div>
      <Card className="relative rounded-xl overflow-hidden border border-solid border-dark">
        ...
        <CardHeader className="relative z-10 text-white">
          ...
          <CardDescription className="pt-8 text-zinc-100 text-lg font-semibold [text-shadow:_0_2px_4px_rgba(0,0,0,0.8),_0_4px_8px_rgba(0,0,0,0.6),_0_8px_16px_rgba(0,0,0,0.4)]">
